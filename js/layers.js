        ...
        switch (currentShadeLayerOp) {
            ...
            case "error-dither":
                ...
                if ($('#color-channel').val() == "individualColor") {
                    ...
                    var colorSystem = "gray";
                }
                console.log("layers.js: colorSystem", colorSystem)  
                imageproc.errorDither(inputImage, outputImage,  colorSystem,
    ...
    imageproc.operation = function(inputImage, outputImage, customMatrix) {
        ...
        if (currentOutlineLayerOp != "no-op") {
            ...
            if (currentOutlineLayerOp == "sobel" &&
                ...
                var non_edge = isFlip ? 255 :0 
                for (var i = 0; i < outlineLayer.data.length; i += 4) {
                    if (outlineLayer.data[i] == non_edge && outlineLayer.data[i + 1] == non_edge && outlineLayer.data[i + 2] == non_edge){
